...
public interface SpeedtestApi {
  ...
  @ApiOperation(
      ...
      notes = "Measures the results of an successful speedtest and persists the result.",
  ...
  @RequestMapping(value = "/speedtest", produces = "application/json", method = RequestMethod.GET)
  ...
  @RequestMapping(
      value = "/speedtest-history",
      produces = "application/json",
      method = RequestMethod.GET)
  ResponseEntity<List<SpeedtestResult>> speedtestHistoryGet(
      @NotNull
          @ApiParam(
